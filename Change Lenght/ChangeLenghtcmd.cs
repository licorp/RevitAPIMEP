...
namespace Quoc_MEP
{
    ...
    public class ChangeLenghtcmd : IExternalCommand
    {
        ...
        {
            Logger.StartOperation("ChangeLenghtcmd.Execute");
            ...
            try
            {
                ...
                Logger.EndOperation("ChangeLenghtcmd.Execute");
    ...
    public class LengthChangeEventHandler : IExternalEventHandler
    {
        ...
        {
            Logger.StartOperation($"LengthChangeEventHandler.Execute - Length: {LengthMm}mm");
            ...
            try
            {
                ...
                XYZ pickPoint = UIDoc.Selection.PickPoint("Click vào điểm gần ống (điểm này sẽ là điểm cố định) / Click near pipe (this will be the fixed point)");
            ...
            {
                Logger.EndOperation("LengthChangeEventHandler.Execute");
            }
        }
